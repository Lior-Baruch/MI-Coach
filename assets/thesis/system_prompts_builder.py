# Copied from thesis repo Thesis_PTO_GRPO (Exp3_PTO_GRPO/code/system_prompts_builder.py), 2026-07-13.
# Patient/therapist persona system prompts. Do not edit here; treat thesis repo as source of truth.
import random
